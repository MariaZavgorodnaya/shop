                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/single-product">Shopping Cart</a>
                                                    </li>
                                                    <li>
                                                        <a href="/shop-checkout">Checkout</a>
                                                    </li>
                                                    <li>
                                                        <a href="/shop-register">Registration</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <!-- eof shop -->
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="/blog-post">Right Sidebar</a>
                                                    </li>
                                                    <li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="blog-video">Right Sidebar</a>
                                                    </li>
                                                    <li>
                ...
                <div class="widget widget_recent_posts">
                    ...
                    <ul class="media-list">
                        <li class="media">
                            ...
                            @forelse($sidebar_posts as $side)
                            <div class="media-left media-middle">
                               {{$side->cover}}
                            </div>
                            <div class="media-body media-middle" style="display:block;margin-bottom:10px;">
                                <h4>
                                    <a href="/blog-post">
                                        {{ $side->title }}
                                    </a>
                                ...
                                <span class="entry-date highlight3 small-text">
												<time class="entry-date" datetime="2017-03-13">
													{{ $side->created_at}}
												</time>
											</span>
                            </div>
